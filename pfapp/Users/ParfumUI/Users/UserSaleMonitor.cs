    ...
    public partial class UserSaleMonitor : Form
    {
        ...
        private void btnSale_Click(object sender, EventArgs e)
        {
            if (ParfumMessenge.IsAreYouSure("Are You Sure"))
            {
                ...
                int userId = LoadCommonData._db.Users.FirstOrDefault(dr => dr.FullName == UserName).Id;
            IsEmptyDataGrid:;
                ...
                foreach (DataGridViewRow row in dataGridViewSales.Rows)
                {
                    ...
                    int price = Price.Price * saleCount;
                    Sale sale = new Sale()
                    {
                    ...
                    ParfumMessenge.Warning($": Parfum {Price.Parfume.Brend.Name} / {Price.Parfume.Name} Saled. Your Price: {price} ");
